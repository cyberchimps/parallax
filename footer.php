							...
							<?php if( !dynamic_sidebar( 'cyberchimps-footer-widgets' ) ) : ?>
								...
								<aside class="widget-container span3">
									...
									<ul>
										...
										<li><a href="<?php echo esc_url( __( 'http://wordpress.org/', 'parallax' ) ); ?>" target="_blank"
										       title="<?php esc_attr_e( 'Powered by WordPress, state-of-the-art semantic personal publishing platform.', 'parallax' ); ?>"> <?php _e( 'WordPress', 'parallax' ); ?></a>
										</li>
										<?php wp_meta(); ?>
									</ul>
								</aside>
